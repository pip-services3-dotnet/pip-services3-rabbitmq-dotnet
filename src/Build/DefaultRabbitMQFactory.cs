...
namespace PipServices3.RabbitMQ.Build
{
    ...
    {
        public static Descriptor Descriptor = new Descriptor("pip-services3", "factory", "rabbitmq", "default", "1.0");
        public static Descriptor RabbitMQMessageQueueFactoryDescriptor = new Descriptor("pip-services3", "factory", "message-queue", "rabbitmq", "1.0");
        public static Descriptor RabbitMQMessageQueueDescriptor = new Descriptor("pip-services3", "message-queue", "rabbitmq", "*", "1.0");
